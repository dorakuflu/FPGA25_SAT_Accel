...
#define _FPGA_MAX_CLAUSES 131072        // 262k - increased from 131k (2x)
...
// this is the number of elements in the clsStore cache
#define _HOST_MAX_CLAUSE_ELEMENTS (_HOST_MAX_LITERAL_ELEMENTS/128)
